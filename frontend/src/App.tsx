...
const TRANSLATIONS: { [key: string]: { [key: string]: string } } = {
  en: {
    ...
    simplifiedChinese: "Simplified Chinese (?体中文)",
  ...
  'zh-CN': {
    ...
    documentAi: "文? AI 分析",
    knowledgeBase: "知??",
    erpIntegration: "ERP ?据集成",
    realData: "???据?查",
    internalPortal: "企??部平台",
    language: "?言切?",
    english: "English",
    traditionalChinese: "繁體中文",
    simplifiedChinese: "?体中文",
    internalAnnouncements: "?部公告",
    createAnnouncement: "?布新公告",
    title: "公告??",
    category: "分?目?",
    content: "???容",
    authorName: "作者姓名",
    postAnnouncement: "确??布",
    placeholderTitle: "例如：服?器??通知",
    placeholderContent: "?在此?入公告???容...",
    filterAll: "全部公告",
    filterGeneral: "常?",
    filterHr: "人事部",
    filterFinance: "??部",
...
const DICTIONARY: { [key: string]: { [key: string]: string } } = {
  // General & Layout
  "Smart Enterprise AI Platform": { "zh-TW": "智能企業 AI 平台", "zh-CN": "智能企? AI 平台" },
  "Internal Portal": { "zh-TW": "內部企業門戶", "zh-CN": "?部企???" },
  "Search...": { "zh-TW": "搜尋...", "zh-CN": "搜索..." },
  "Search employee or position...": { "zh-TW": "搜尋員工姓名或職位...", "zh-CN": "搜索?工姓名或?位..." },
  "Welcome to Cotton Republic Portal": { "zh-TW": "歡迎來到棉花共和國門戶", "zh-CN": "?迎?到棉花共和???" },
  "Dah Je Co LTD (大傑有限公司) ‧ Smart Enterprise AI Platform": { "zh-TW": "大傑有限公司 ‧ 智能企業 AI 平台", "zh-CN": "大杰有限公司 ‧ 智能企? AI 平台" },

  // Dashboard Indicators
  "Total POs": { "zh-TW": "採購單總數", "zh-CN": "采????" },
  "Total SOs": { "zh-TW": "銷售單總數", "zh-CN": "?售???" },
  "Inventory Items": { "zh-TW": "庫存品項總計", "zh-CN": "?存品???" },
  "Low Stock Alerts": { "zh-TW": "低庫存警警報", "zh-CN": "低?存警警?" },
  "Low Stock Items": { "zh-TW": "低庫存品項", "zh-CN": "低?存品?" },
  
  // HR Services
  "HR Services & Contacts": { "zh-TW": "人事服務與聯絡窗口", "zh-CN": "人事服?与??窗口" },
  "Employee Directory (Kaggle HR Dataset)": { "zh-TW": "員工名冊 (Kaggle HR 數據集)", "zh-CN": "?工名? (Kaggle HR ?据集)" },
  "All Departments": { "zh-TW": "所有部門", "zh-CN": "所有部?" },
  "HR Director": { "zh-TW": "人事總監", "zh-CN": "人事??" },
  "Recruitment Manager": { "zh-TW": "招聘經理", "zh-CN": "招聘?理" },
  "Employee Relations": { "zh-TW": "員工關係專員", "zh-CN": "?工?系??" },
  "Dept:": { "zh-TW": "部門:", "zh-CN": "部?:" },
  "Salary:": { "zh-TW": "薪資:", "zh-CN": "薪?:" },
  "Manager:": { "zh-TW": "直屬主管:", "zh-CN": "直?主管:" },
  "Hired:": { "zh-TW": "入職日期:", "zh-CN": "入?日期:" },
  "Absences:": { "zh-TW": "缺勤天數:", "zh-CN": "缺勤天?:" },
  "Satisfaction:": { "zh-TW": "滿意度評分:", "zh-CN": "?意度?分:" },
  "Fully Meets": { "zh-TW": "符合預期指標", "zh-CN": "符合?期指?" },
  "Exceeds": { "zh-TW": "超出預期表現", "zh-CN": "超出?期表?" },

  // Leave Management
  "Submit Leave Request": { "zh-TW": "提交請假申請表格", "zh-CN": "提交?假申?表格" },
  "Leave Type": { "zh-TW": "請假假別類型", "zh-CN": "?假假??型" },
  "Annual Leave": { "zh-TW": "特休/年假", "zh-CN": "特休/年假" },
  "Sick Leave": { "zh-TW": "病假", "zh-CN": "病假" },
  "Personal Leave": { "zh-TW": "事假", "zh-CN": "事假" },
  "Start Date": { "zh-TW": "開始請假日期", "zh-CN": "?始?假日期" },
  "End Date": { "zh-TW": "結束請假日期", "zh-CN": "?束?假日期" },
  "Reason": { "zh-TW": "詳細請假原因", "zh-CN": "???假原因" },
  "Brief details...": { "zh-TW": "請在此輸入請假事由簡述...", "zh-CN": "?在此?入?假事由?述..." },
  "Submit Request": { "zh-TW": "確定送出申請", "zh-CN": "确定送出申?" },
  "Your Leave Requests History": { "zh-TW": "您的請假申請歷史記錄", "zh-CN": "您的?假申??史??" },
  "Employee": { "zh-TW": "申請員工姓名", "zh-CN": "申??工姓名" },
  "Type": { "zh-TW": "假別類型", "zh-CN": "假??型" },
  "Status": { "zh-TW": "審批狀態", "zh-CN": "?批??" },
  "Comments": { "zh-TW": "審查主管評語", "zh-CN": "?查主管??" },
  "Pending": { "zh-TW": "審核中", "zh-CN": "?核中" },
  "Approved": { "zh-TW": "審批已核准", "zh-CN": "?批已核准" },

  // Document Center
  "Uploaded Documents": { "zh-TW": "已上傳存檔文件", "zh-CN": "已上?存?文件" },
  "Upload Document": { "zh-TW": "上傳存檔新文件", "zh-CN": "上?存?新文件" },
  "Document Name": { "zh-TW": "上傳文件名稱", "zh-CN": "上?文件名?" },
  "File Text Content": { "zh-TW": "文件文本詳細內容", "zh-CN": "文件文本???容" },
  "Paste document text or invoice values here...": { "zh-TW": "請在此貼上文件內容或發票數值...", "zh-CN": "?在此?上文件?容或?票?值..." },
  "Save Document": { "zh-TW": "儲存並保存文件", "zh-CN": "?存并保存文件" },

  // Workflow Approvals
  "Workflow & Request Approvals": { "zh-TW": "工作流與請求審計審批", "zh-CN": "工作流与?求???批" },
  "Pending Actions": { "zh-TW": "待處理審核項目", "zh-CN": "待?理?核?目" },
  "Approval Audit Logs": { "zh-TW": "審核歷史審計日誌", "zh-CN": "?核?史??日志" },
  "Task Detail": { "zh-TW": "審批任務詳情", "zh-CN": "?批任??情" },
  "Requested By": { "zh-TW": "申請人姓名", "zh-CN": "申?人姓名" },
  "Date": { "zh-TW": "申請日期時間", "zh-CN": "申?日期??" },
  "Outcome": { "zh-TW": "審查結果", "zh-CN": "?查?果" },
  "Approve": { "zh-TW": "審查同意核准", "zh-CN": "?查同意核准" },
  "Reject": { "zh-TW": "拒絕駁回退回", "zh-CN": "拒??回退回" },
  "Enter approval note / REJECTION reason (Mandatory)": { "zh-TW": "請輸入審批意見或拒絕原因(必填)", "zh-CN": "??入?批意?或拒?原因(必填)" },

  // ERP Access
  "ERP / MES Integration Center": { "zh-TW": "ERP / MES 系統集成控制中心", "zh-CN": "ERP / MES 系?集成控制中心" },
  "Material & Inventory (MES)": { "zh-TW": "物料與庫存管理系統 (MES)", "zh-CN": "物料与?存管理系? (MES)" },
  "Procurement (Purchase Orders)": { "zh-TW": "採購供應鏈模組 (採購單)", "zh-CN": "采?供??模? (采??)" },
  "Finance & Sales (SO)": { "zh-TW": "財務與銷售模組 (銷售單)", "zh-CN": "??与?售模? (?售?)" },
  "Active ERP Gateway Status": { "zh-TW": "活躍 ERP 網關通訊狀態", "zh-CN": "活? ERP 网?通???" },
  "SAP ERP Financials Gateway": { "zh-TW": "SAP ERP 財務總賬網關", "zh-CN": "SAP ERP ????网?" },
  "Production MES Floor Scheduler": { "zh-TW": "MES 生產車間排程調度器", "zh-CN": "MES 生???排程?度器" },
  "Workday HR Employee Database Sync": { "zh-TW": "Workday 人力資源數據庫同步", "zh-CN": "Workday 人力?源?据?同步" },
  "Legacy Warehouse WMS API": { "zh-TW": "傳統倉庫管理 (WMS) 連接埠", "zh-CN": "????管理 (WMS) ?接口" },
  "Connected": { "zh-TW": "通訊已連接", "zh-CN": "通?已?接" },
  "Maintenance": { "zh-TW": "維護保養中", "zh-CN": "??保?中" },

  // Workflows View
  "Defined Enterprise Workflows": { "zh-TW": "已定義之企業工作流", "zh-CN": "已定?之企?工作流" },
  "Leave Approval Protocol": { "zh-TW": "請假審批流程協議", "zh-CN": "?假?批流程??" },
  "Procurement Capex Approval": { "zh-TW": "採購資本支出審批", "zh-CN": "采??本支出?批" },
  "New Vendor Onboarding Policy": { "zh-TW": "新供應商入駐政策流程", "zh-CN": "新供?商入?政策流程" },
  "2-step validation": { "zh-TW": "兩階段驗證", "zh-CN": "??段??" },
  "3-step budget check": { "zh-TW": "三階段預算審查", "zh-CN": "三?段?算?查" },
  "1-step contract check": { "zh-TW": "單階段合約核對", "zh-CN": "??段合?核?" },
  ...
  "Paste invoice texts, shipping slip data, or employee memos to trigger automated entity extraction and summaries via AI.": {
    ...
    "zh-CN": "?在下方?上?票文本、出???据或?工?忘?，以触? AI 自?化?体提取与摘要。"
  },
  "Extract Entities & Summary": { "zh-TW": "開始提取實體與摘要", "zh-CN": "?始提取?体与摘要" },
  "AI Extraction Results": { "zh-TW": "AI 數據提取分析結果", "zh-CN": "AI ?据提取分析?果" },
  "Submit raw text in the left panel to review extracted details.": { "zh-TW": "請在左側面板提交原始文本以查看提取的詳細資訊。", "zh-CN": "?在左?面板提交原始文本以查看提取的??信息。" },

  // Knowledge Base View
  "Articles": { "zh-TW": "企業知識庫文章", "zh-CN": "企?知??文章" },
  "Cotton Republic Head Office Info": { "zh-TW": "棉花共和國總部資訊指南", "zh-CN": "棉花共和??部??指南" },
  "Travel Disposable Underwear Tech Specs": { "zh-TW": "旅行一次性內衣技術規格說明", "zh-CN": "旅行一次性?衣技??格?明" },
  "How to Submit and Manage Leaves": { "zh-TW": "如何提交與管理您的請假申請", "zh-CN": "如何提交与管理您的?假申?" },
  "Add Article": { "zh-TW": "新增知識庫文章", "zh-CN": "新增知??文章" },
  "Select an article from the left sidebar to start reading.": { "zh-TW": "請從左側欄選擇一篇文章開始閱讀。", "zh-CN": "??left側欄??一篇文章?始??。" },
  "Add": { "zh-TW": "確定新增", "zh-CN": "确定新增" },

  // Database Sync Control
  "ERP Database Sync Control": { "zh-TW": "ERP 資料庫同步控制台", "zh-CN": "ERP ?据?同步控制台" },
  "Database Synchronization Logs": { "zh-TW": "系統資料庫同步日誌", "zh-CN": "系??据?同步日志" },
  "Sync Database Now": { "zh-TW": "立即執行資料庫同步", "zh-CN": "立即?行?据?同步" },
  "MES Production": { "zh-TW": "MES 生產製造系統", "zh-CN": "MES 生?制造系?" },
  "SAP Financials": { "zh-TW": "SAP 財務會計系統", "zh-CN": "SAP ????系?" },
  "Workday HR DB": { "zh-TW": "Workday 人事資料庫", "zh-CN": "Workday 人事?据?" },
  "Legacy Warehouse WMS": { "zh-TW": "舊款倉庫 WMS 系統", "zh-CN": "?款?? WMS 系?" },
  "30 records": { "zh-TW": "30 筆同步記錄", "zh-CN": "30 ?同步??" },
  "31 records": { "zh-TW": "31 筆同步記錄", "zh-CN": "31 ?同步??" },
  "3 records": { "zh-TW": "3 筆同步記錄", "zh-CN": "3 ?同步??" },
  "Failed": { "zh-TW": "同步失敗", "zh-CN": "同步失?" },
  "Success": { "zh-TW": "同步成功", "zh-CN": "同步成功" },
  "Timestamp": { "zh-TW": "同步時間戳", "zh-CN": "同步??戳" },
  "Details": { "zh-TW": "日誌詳情", "zh-CN": "日志?情" },

  // Real Data View
  "Database Inspector: INVENTORY": { "zh-TW": "資料庫檢查器：實時庫存", "zh-CN": "?据??查器：???存" },
  "Database Tables": { "zh-TW": "系統資料數據表", "zh-CN": "系??料?据表" },
  "PRODUCT NAME": { "zh-TW": "產品品名", "zh-CN": "?品品名" },
  "CATEGORY": { "zh-TW": "品類分類", "zh-CN": "品?分?" },
  "STOCK LEVEL": { "zh-TW": "庫存水位", "zh-CN": "?存水位" },
  "PRICE": { "zh-TW": "單價價格", "zh-CN": "?价价格" },
  "Total Records:": { "zh-TW": "總記錄數:", "zh-CN": "????:" }
};
...
const LOCALIZED_ANNOUNCEMENTS: { [key: string]: any[] } = {
  ...
  'zh-CN': [
    { id: 1, title: '混合?公指南更新', content: '根据公司最新政策，台北?部的?工每周可申?最多3天的?程?公。?与??主管??您的??安排，并在人事服?中??。', author: 'David Vance (HR 主管)', category: 'HR', date: '2026-07-05' },
    { id: 2, title: '精梳棉生?新目?', content: 'MES 工厂正在?大功能性一次性旅行?衣?品?的生??模。?确保通?采???卡?理 A ?棉花原材料的?存??。', author: 'Sarah Jenkins (????)', category: 'Finance', date: '2026-07-08' },
    { id: 3, title: '?迎?到棉花共和???网站', content: '我?很高??棉花共和?（大杰有限公司）推出全新的智能企? AI 平台。???网站集成了人事服?、?假管理、?? ERP/MES ??，并提供 AI ?同助手以?取??和物流??。', author: '系?管理?', category: 'General', date: '2026-07-01' }
  ]
};
        ...
        <div style={{
          ...
          <div style={{ position: 'absolute', top: '1.5rem', right: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            >
              ...
              <option value="zh-CN" style={{ backgroundColor: '#111', color: '#fff' }}>?体中文 (Simplified)</option>
            </select>
          </div>
        ...
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            >
              ...
              <option value="zh-CN" style={{ backgroundColor: '#111' }}>?体</option>
            </select>
...
function AICopilotView({ isAiOnline, inventory, purchaseOrders, salesOrders, employees = [], lang }: any) {
  const greeting = lang === 'zh-TW' 
    ...
    : lang === 'zh-CN' 
    ? '您好！我是您的智能?? AI ?同助手。您可以??我?于?存指?、采??、?售?或?工与人事部的?据，也能?您解答各???与?假政策。今天有什么我可以?您的？' 
    ...
    if (isAiOnline) {
      try {
        ...
        const fallbackText = lang === 'zh-TW'
          ...
          : lang === 'zh-CN'
          ? `?法?接至云端 AI 服?。?确? FastAPI 服?是否在端口 8080 正常?行。\n\n*本地模?回复*：目前采???：30，?售??：41，?存??：30件，人事部?工???：${employees.length}名。`
      ...
      setTimeout(() => {
        ...
        if (lang === 'zh-TW') {
          ...
          answer += "系?目前?行于离?模?模式。?在 Render 或本地端?? Python FastAPI 服?，并配置您的 Hugging Face 密???用完整的 Qwen 智能模型。\n\n";
          if (userMsg.toLowerCase().includes('inventory') || userMsg.toLowerCase().includes('stock') || userMsg.includes('?存') || userMsg.includes('存?')) {
            answer += `???存??：我?在 ERP ?据?中?有 ${inventory.length} 件??品和面料。其中，1 件???「低?存」??，急需??。`;
          } else if (userMsg.toLowerCase().includes('po') || userMsg.toLowerCase().includes('purchase') || userMsg.includes('采?')) {
            answer += `采????：?前系?中已同步并??了 ${purchaseOrders.length} ?活?采???。`;
          } else if (userMsg.toLowerCase().includes('so') || userMsg.toLowerCase().includes('sales') || userMsg.includes('?售')) {
            answer += `?售???：?前系?中已?理并??了 ${salesOrders.length} ?活??售??。`;
          } else if (userMsg.toLowerCase().includes('employee') || userMsg.toLowerCase().includes('hr') || userMsg.includes('?工') || userMsg.includes('雇?') || userMsg.includes('人?') || userMsg.includes('人事')) {
            answer += `人事部??：我?的人力?源系?中目前注?了 ${employees.length} 名?工。您可以在「人事服?」?面查看完整的?工名?和主管名?。`;
          } else {
            answer += `模?助手回复：“${userMsg}”。???有什么我可以?助您查?的?？`;
          }
        } else {
