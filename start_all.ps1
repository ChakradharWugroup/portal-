...
Write-Host "  - Portal Frontend:    http://${ipAddress}.nip.io:3005" -ForegroundColor Green
Write-Host "  - Portal Backend:     http://${ipAddress}.nip.io:8005" -ForegroundColor Green
Write-Host "  - NextChat:           http://${ipAddress}.nip.io:3001" -ForegroundColor Green
Write-Host "  - RVC Studio:         http://${ipAddress}.nip.io:3002" -ForegroundColor Green
Write-Host "  - Unified AI API:     http://${ipAddress}.nip.io:8080" -ForegroundColor Green
Write-Host "==============================================" -ForegroundColor Green

Write-Host "Waiting 8 seconds for services to start before opening browser..." -ForegroundColor Cyan
Start-Sleep -Seconds 8
Start-Process "http://${ipAddress}.nip.io:3005"
